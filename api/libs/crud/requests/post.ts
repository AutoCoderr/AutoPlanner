...
export default function post<M extends Model,IData = any>(model: ModelStatic<M>, formGetter: IFormGetter<M,IData>, createAccessCheck: null|ICreateAccessCheck = null, params: ICrudParams<M>&IGetAndCheckExistingResourceParams<M> = {}) {
