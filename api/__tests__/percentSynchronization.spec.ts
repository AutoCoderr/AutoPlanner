...
describe("Test folder synchronization", () => {
    let t;
...
describe("Test step synchronization", () => {
    let t;
...
describe("Test todo synchronization", () => {
    let t;
    ...
    test("Calcul todo synchronized percent", async () => {
        expect(
            ...
            ((stepNodeA1.percent + stepNodeB2.percent + stepNodeC2.percent) / (5.5 * 100)) * 100
        )
    })
});